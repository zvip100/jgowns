  ...
  return (
    ...
    >
      ...
      <div className="relative grid gap-10 px-6 sm:px-10 lg:grid-cols-12 lg:gap-14 lg:px-14">
        <div className="stagger-rise lg:col-span-5">
        ...
        <div className="lg:col-span-7">
          <div className="surface-panel hairline rounded-[1.7rem] p-6 sm:p-8 lg:p-10">
            <p className="mb-7 text-[0.66rem] font-semibold uppercase tracking-[0.22em] text-(--muted-ink)">
              How it works
            </p>
            <ol className="flex flex-col gap-7">
              {steps.map((s) => (
                <li key={s.n} className="flex items-start gap-5">
                  <span
                    aria-hidden
                    className="font-display text-3xl font-medium leading-none text-(--accent-deep) sm:text-[2.2rem]"
                  >
                    {s.n}
                  </span>
