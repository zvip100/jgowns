...
export const AUDIT_ACTION_LABELS: Record<AdminAuditAction, string> = {
  ...
  "listing.image_add": "Photo added",
  "listing.image_remove": "Photo removed",
  "listing.image_reorder": "Photos reordered",
  "listing.image_replace": "Photo replaced",
  "listing.image_reprocess": "Photo reprocessed",
...
export const AUDIT_ACTION_TONES: Record<AdminAuditAction, PillTone> = {
  ...
  "listing.image_add": "neutral",
  "listing.image_remove": "warning",
  "listing.image_reorder": "neutral",
  // Warning, matching image_remove: a replace destroys the photo that was there.
  "listing.image_replace": "warning",
  "listing.image_reprocess": "neutral",
